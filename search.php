...
<?php
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            // echo "Name: " . $row["item_name"]. "<br>Description: " . $row["item_desc"]. "<br>Stock: " . $row["item_stock"] . "<br>";
            echo "Name: " . htmlentities($row["item_name"], ENT_QUOTES) . "<br>Description: " . htmlentities($row["item_desc"], ENT_QUOTES) . "<br>Stock: " . htmlentities($row["item_stock"], ENT_QUOTES) . "<br>";
        }
    } else {
