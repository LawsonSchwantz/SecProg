...
<body>
    ...
    ?>
     ...
     <main>
        ...
        foreach ($data as $row) {
            echo "<tr>";
            // htmlentities($row["item_stock"], ENT_QUOTES)
            echo "<td> <img class = 'item-image' src='" . htmlentities($row['item_picture'], ENT_QUOTES) . "' alt='Item Picture'>
            <p class='item_name'>" . htmlentities($row['item_name'], ENT_QUOTES) . "</p>            
            <p class='item_desc'>". htmlentities($row['item_desc'], ENT_QUOTES) ."</p>
            <p class='stocks'>Stock: ". htmlentities($row['item_stock'], ENT_QUOTES) ."</p>
            </td>";
